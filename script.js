...
for (let i = 0; i < projects.length; i + 1) {
  ...
  projectButtons[i].addEventListener('click', () => {
    ...
    if (window.innerWidth < 768) {
      ...
      popupWindowContent.append(closeMobilePopupWindow, popupImageBoxs[i]);
      popupWindowContent.append(popupTitleAndButtonsBox, popupTechList[i], projectDescriptions[i]);
    }
